...
class FilterCategoriesAjax{
    ...
    {
        add_action('wp_ajax_searchPostByCategory', [self::class, 'searchPostByCategory']); 
        add_action('wp_ajax_nopriv_searchPostByCategory', [self::class, 'searchPostByCategory']);
    }

    /**
     * Поиск слотов по названию
     */
    public static function searchPostByCategory(): void
    {
        ...
        $query = new Query();
        $postsIds = $query->getPostsByCategory($searchTerm);
